...
const BrowserView = ({ url, onDidNavigate, onDidFailLoad, onLoading, onNavigationStateChange, style }) => {
    const webviewRef = (0, react_1.useRef)();
    const [errorData, setErrorData] = (0, react_1.useState)(null);
    ...
    if (errorData) {
        return ((0, jsx_runtime_1.jsxs)("div", { className: "webview-error", style: {
                padding: '20px',
                textAlign: 'center',
                height: '100%',
                display: 'flex',
                ...
                ...style
            }, children: [(0, jsx_runtime_1.jsx)("h2", { children: "Navigation Error" }), (0, jsx_runtime_1.jsxs)("p", { children: ["Could not navigate to: ", errorData.url] }), (0, jsx_runtime_1.jsxs)("p", { children: ["Error: ", errorData.description, " (Code: ", errorData.code, ")"] }), (0, jsx_runtime_1.jsx)("button", { onClick: () => {
    ...
    return ((0, jsx_runtime_1.jsx)("webview", { ref: webviewRef, src: url, style: {
            width: '100%',
            height: '100%',
            border: 'none',
            ...style
        }, allowpopups: "true", webpreferences: "contextIsolation=yes, nodeIntegration=no" }));
};
